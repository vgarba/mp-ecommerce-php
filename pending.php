...
<h2>Gracias por tu compra. Tu pago esta pendiente.</h2>
<div>Payment ID:<?php echo $collection_id ?> </div>

<div>Payment Status:<?php echo $collection_status ?> </div>

<div>External Reference:<?php echo $external_reference ?> </div>
<!--
<div>Payment Type:<?php echo $payment_type ?> </div>

<div>Payment Method ID:<?php echo $payment_method_id ?> </div>

<div>Preferences ID:<?php echo $preference_id ?> </div>
